...
import { ClipType, Clip } from "../model/clip";
...
export default function ClipCard({
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4 sm:p-6 bg-white shadow-sm md:w-full w-80 relative group">
      ...
      {isCode ? (
        ...
        <p className="text-gray-700 mb-4 min-h-[100px] break-words">
          {truncateContent(clip.content)}
        </p>
      )}
      ...
      {clip.url && (
        <a
          ...
          className="text-gray-600 flex text-xs items-center font-medium hover:text-blue-600 mb-4 break-all"
        >
          <Link className="inline-block mr-1 flex-shrink-0" size={14} />
